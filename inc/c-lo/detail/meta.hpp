...
using append_to_index_sequence_t =
    typename append_to_index_sequence<Index, IndexSequence>::type;
...
using append_to_index_sequence_if_t =
    typename append_to_index_sequence_if<Index, IndexSequence, Append>::type;
